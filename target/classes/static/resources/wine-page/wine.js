...
class Wine_Cell {
    ...
    save(parent) {
        ...
        payload.tipoId = wine.tipo.tipoId;
        payload.originId = wine.origin.originId;
...
const createPurchasePriceCell = () => {
    purchase_price_cell = new Wine_Cell({
        ...
        value: round_num_opt(wine.price),
        add_euro_sign: true,
        popup: {
            header: {
...
const createEvents = () => {
    $("#action-edit").on("click", function () {
        window.location = "/wine/" + wine.wineId + "/edit/";
    });
};
